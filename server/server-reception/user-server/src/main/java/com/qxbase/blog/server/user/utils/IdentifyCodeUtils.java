package com.qxbase.blog.server.user.utils;
...
public class IdentifyCodeUtils {
    ...
    * @return
    */
    public static BufferedImage getIdentifyImage(String identifyCode) {
    ...
    * 绘制字符串
    */
    private static void drawString(Graphics g, String identifyCode) {
    ...
    * @param response
    */
    public static void responseIdentifyImg(BufferedImage identifyImg, HttpServletResponse response) {
